...
The v0.5.0 Apple Silicon and Intel macOS artifacts are unsigned and not notarized. macOS may require users to approve the app in Privacy & Security before first launch. Future public macOS candidates must pass the repository's opt-in Developer ID signing and notarization workflow; unsigned workflow artifacts remain tester builds.
