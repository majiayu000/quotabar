...
- Redesign the tray overview with large provider rings, quota windows and reset times. Preserve missing-data, stale-data and recovery states; display remaining quota consistently.
