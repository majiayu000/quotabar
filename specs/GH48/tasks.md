...
- [x] `SP48-T5` Owner: codex. Dependencies: T1-T4. Covers: `B-001`~`B-006`. Done when: 9-path allowlist、checker 100%、overall diff ≥80%、notifications critical diff 100%、full frontend/build/Rust pass。 Verify: tech Test Plan。
