...
- [x] `SP27-T2` Owner: codex. Done when: ccstats is pinned to a revision that exposes `summarize_cost_ranges`. Verify: `rg -n "summarize_cost_ranges|2bfaf3ac1e4a377e994fc2e19739cb5ed00e76fc" src-tauri`.
